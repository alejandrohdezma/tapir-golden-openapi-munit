...
```sbt
libraryDependencies += "com.alejandrohdezma" %% "tapir-golden-openapi-munit" % "0.6.1" % Test
```
...
```sbt
libraryDependencies += "com.alejandrohdezma" %% "tapir-golden-openapi-munit-validator" % "0.6.1" % Test
```
